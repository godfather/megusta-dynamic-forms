...
})(exports.RequestTypeEnum || (exports.RequestTypeEnum = {}));
exports.FieldTypesEnum = void 0;
(function (FieldTypesEnum) {
    FieldTypesEnum["TEXT_FIELD"] = "TEXT";
    FieldTypesEnum["TEXTAREA"] = "TEXTAREA";
    FieldTypesEnum["CHECKBOX"] = "CHECKBOX";
    FieldTypesEnum["CHECKBOX_GROUP"] = "CHECKBOX_GROUP";
    FieldTypesEnum["RADIO_GROUP"] = "RADIO_GROUP";
    FieldTypesEnum["FILE"] = "FILE";
    FieldTypesEnum["EMAIL"] = "EMAIL";
})(exports.FieldTypesEnum || (exports.FieldTypesEnum = {}));
...
const useMDFApi = () => {
    ...
    const list = () => req({ url: mountUrl(null) });
    const load = (id) => req({ url: mountUrl(id) });
    const send = (id, body) => req({
        url: mountUrl(id ? id.toString() : null),
        method: exports.RequestTypeEnum.POST,
        headers: { 'Content-Type': 'application/json' },
        body: body
    });
    const destroy = (formId, fieldId) => req({
        url: fieldId ? mountUrl(`${formId.toString()}/fields/${fieldId}`) : mountUrl(formId.toString()),
        method: exports.RequestTypeEnum.DELETE
    });
    const req = (requestConfig) => {
        setIsLoading(true);
        setError(null);
        return fetch(requestConfig.url, {
            method: requestConfig.method || exports.RequestTypeEnum.GET,
